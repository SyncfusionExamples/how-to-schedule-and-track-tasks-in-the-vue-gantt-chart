...
export let projectNewData =  [
    {
        ...
        subtasks: [
            ...
            { TaskID: 3, TaskName: 'Defining target audience', StartDate: new Date('04/02/2019'), Duration: 3 },
            {
                ...
                Predecessor: '2', Progress: 30, isManual : true,
            },
        ]
    },
    {
        TaskID: 5, TaskName: 'Concept approval', StartDate: new Date('04/02/2019'), Duration: 3, Predecessor: '3,4',
        Indicators: [
            {
                'date': '04/12/2019',
                'name': 'Design Phase',
    ...
    },
    {
        ...
        subtasks: [
            ...
            },
            {
                ...
                Predecessor: '7, 8', Progress: 30, isManual : true,
            },
